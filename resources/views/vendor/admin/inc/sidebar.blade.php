		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				@if (auth()->user()->can('list-payment') || userHasSuperAdminPermissions())
					...
					<li><a href="{{ admin_url('withdrawals') }}"><i class="fa fa-credit-card"></i> <span>{{ trans('admin::messages.withdrawals') }}</span></a></li>

					<li><a href="{{ admin_url('payments') }}"><i class="fa fa-list-alt"></i> <span>{{ trans('admin::messages.deposites') }}</span></a></li>

					<li><a href="{{ admin_url('payments') }}"><i class="fa fa-money"></i> <span>{{ trans('admin::messages.transactions') }}</span></a></li>

					<li class="treeview">
						<a href="#"><i class="fa fa-dedent"></i> <span>{{ trans('admin::messages.withdrawal methods') }}</span><i class="fa fa-angle-left pull-right"></i></a>
						<ul class="treeview-menu">	
							<li><a href="{{ admin_url('payments') }}"><i class="fa fa-empire"></i> <span>{{ trans('admin::messages.add methods') }}</span></a></li>
							<li><a href="{{ admin_url('payments') }}"><i class="fa fa-external-link"></i> <span>{{ trans('admin::messages.link method to currency') }}</span></a></li>
						</ul>
					</li>

					<li class="treeview">
						<a href="#"><i class="fa fa-diamond"></i> <span>{{ trans('admin::messages.deposit methods') }}</span><i class="fa fa-angle-left pull-right"></i></a>
						<ul class="treeview-menu">	
							<li><a href="{{ admin_url('payments') }}"><i class="fa fa fa-empire"></i> <span>{{ trans('admin::messages.add methods') }}</span></a></li>
							<li><a href="{{ admin_url('payments') }}"><i class="fa fa-external-link"></i> <span>{{ trans('admin::messages.link method to currency') }}</span></a></li>
						</ul>
					</li>

					<li><a href="{{ admin_url('payments') }}"><i class="fa fa-dollar"></i> <span>{{ trans('admin::messages.currencies') }}</span></a></li>
					<li><a href="{{ admin_url('payments') }}"><i class="fa fa-exchange"></i> <span>{{ trans('admin::messages.currency exchange rates') }}</span></a></li>
				@endif
